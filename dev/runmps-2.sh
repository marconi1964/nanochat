...
# export PYTORCH_MPS_HIGH_WATERMARK_RATIO=0.0            # fall back to CPU when ops unsupported
# export PYTORCH_MPS_LOW_WATERMARK_RATIO=0.1
export OMP_NUM_THREADS=8                        # avoid CPU oversubscription
export MKL_NUM_THREADS=8

# export PYTORCH_INDUCTOR_FUSE_RELU=1
# export PYTORCH_INDUCTOR_CACHE=1


NO_DATASET=800  # 200 - 800
MAX_ITERS=100   # 100 - 20000
DEPTH=4         # 4
MAX_SEQ_LEN=1024    # 1024
DEVICE_BATCH_SIZE=1   # 1 - 8
TOTAL_BATCH_SIZE=1024 # 1024 - 65536
MAX_CHARS=1000000000   # 1000000000
